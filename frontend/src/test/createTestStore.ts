...
function voyoSlice(overrides: Partial<VoyoSlice> = {}): VoyoSlice {
  return {
    ...
    voyoVideoPreview: null,
    setVoyoVideoPreview: noop,
    voyoPreviewLoading: false,
    voyoSearching: false,
    fetchVoyoVideoPreview: noopAsync,
...
function hrtiSlice(overrides: Partial<HrtiSlice> = {}): HrtiSlice {
  return {
    ...
    setSelectedHrtiEpisodes: noop,
    viewMode: "catalog" as const,
    ...
    resolveHrtiUrl: noopAsync,
    hrtiSubmitting: false,
    startHrtiDownload: noop,
    confirmHrtiDownload: noopAsync,
    confirmHrtiBatchDownload: noopAsync,
    backToCatalog: noop,
    ...overrides,
  } as HrtiSlice;
}
