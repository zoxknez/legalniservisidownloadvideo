        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1.5 border-t border-white/[0.03] pt-3">
            ...
            <div className="flex justify-between items-center text-xs font-semibold text-white bg-black/10 p-2 rounded">
              ...
              <span
                className={
                  cookiesConfigured ? "text-emerald-400 font-black" : "text-text-muted font-black"
                }
              >
                {cookiesConfigured ? "Učitani" : "Nisu učitani"}
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="text-xs font-bold text-blue-400 flex items-center gap-1.5 hover:underline w-max mt-1"
          >
            <Settings className="w-3.5 h-3.5" /> Postavke (yt-dlp, šablon imena)
