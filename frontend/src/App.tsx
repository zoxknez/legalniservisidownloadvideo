...
export default function App() {
  ...
  const [transcodeDiagnostics, setTranscodeDiagnostics] = useState<any>(null);
                    ...
                    <div>
                      ...
                      <div className="max-h-60 overflow-y-auto border border-glass rounded-lg bg-black/40 p-2 flex flex-col gap-1">
                        {voyoSeriesData.episodes.map((ep) => {
                          ...
                          return (
                            <div key={ep.id} className="custom-checkbox-wrap" style={{borderRadius:8,padding:"8px 10px", "--checkbox-bg": "#ea580c", "--checkbox-glow": "rgba(249, 115, 22, 0.3)"} as any} onClick={() => {
                  ...
                  {transcodeDiagnostics && (
                    <div className="mt-4 p-4 rounded-xl bg-gradient-to-br from-indigo-950/20 to-purple-950/20 border border-indigo-500/10 glow-indigo-card flex flex-col gap-4 relative overflow-hidden animate-pulse-subtle">
                      ...
                      <div className="flex flex-col gap-1.5 mt-1">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {Object.entries(transcodeDiagnostics.accelerations).map(([key, accel]: [string, any]) => (
                            <span key={key} 
